...
func (c *tenantServiceClient) ModifyTenant(ctx context.Context, in *ModifyTenantRequest, opts ...grpc.CallOption) (*ModifyTenantResponse, error) {
	out := new(ModifyTenantResponse)
	err := c.cc.Invoke(ctx, "/kubegems.services.v1.TenantService/ModifyTenant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tenantServiceClient) ListTenant(ctx context.Context, in *ListTenantRequest, opts ...grpc.CallOption) (*ListTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kubegems.services.v1.TenantService/ListTenant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTenantServiceServer) ModifyTenant(context.Context, *ModifyTenantRequest) (*ModifyTenantResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyTenant not implemented")
}
...
func _TenantService_ModifyTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ModifyTenantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).ModifyTenant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubegems.services.v1.TenantService/ModifyTenant",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).ModifyTenant(ctx, req.(*ModifyTenantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TenantService_ListTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubegems.services.v1.TenantService/ListTenant",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ModifyTenant",
			Handler:    _TenantService_ModifyTenant_Handler,
		},
		{
	...
	Metadata: "kubegems/services/v1/tenant_services.proto",
}
